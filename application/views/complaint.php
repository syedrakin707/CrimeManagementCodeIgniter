...
<img src="<?php echo base_url();?>outside/images/logo.jpg" width="20%" align="left">
	  ...
	  <center><h2>Compliant Information</h2>
			<div class="table-responsive">
						 ...
						 ?>
									<tr>
											...
											<td><a href="<?php echo base_url(); ?>main/updatecomplaint/<?php echo $row->id; ?>">Edit</a></td>
									</tr>
						 <?php
									}
						 }
		            ...
		            <center><a href="<?php echo base_url(); ?>Main/addcomplaint" class="btn btn-warning btn_sm">Add Complaint</a></center>
