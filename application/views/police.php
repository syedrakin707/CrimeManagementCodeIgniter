			...
			<div class="table-responsive">
						 ...
						 ?>
									<tr>
											 ...
											 <td><a href="<?php echo base_url(); ?>main/updatepolice/<?php echo $row->id; ?>">Edit</a></td>
									</tr>
						 <?php
									}
						 }
		            ...
		            <center><a href="<?php echo base_url(); ?>Main/addpolice" class="btn btn-warning btn_sm">Add Police Info</a></center>
